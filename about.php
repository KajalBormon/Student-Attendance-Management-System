...
<div class = "col-lg-7 mcon m-auto">
    ...
    <p align="center" style = "font-size:20px;text-align:justify;">
        An attendance management system refers to an organization's approach to tracking students time and attendance information. An accurate attendance and time tracking system helps you save time and effort in calculating your employees' working hours.
    </p>
    <hr color = "black" size = "2px">
    ...
    <ol style="padding: 10px; font-size: 18px">
        <li>Student attendance management system helps to count to present or absent easily.</li>
        <li>Save much time to take attendance.</li>
        <li>Automatically count the preset and absent days.</li>
        <li>Count the students attendance so that calculate easily the percentage of the students.</li>
        <li>Students can fill the form anywhere and anytime.</li>
        <li>Student can know his/her attendance percentage</li>
        <li>Teacher can easily count the marks of any student.</li>
